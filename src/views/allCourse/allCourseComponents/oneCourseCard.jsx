...
function OneCourseCard(props) {
    ...
    return (
        <div className={classes.root} onClick={() => { history.push(`/${props.path}/${props.courseData?.id}`) }}>
            <section className="cards-mul">
                <article className={`card-sing card--1`}>
                    {/* <div className="card__info-hover">
                        ...
                        <div className="card__clock-info">
                            ...
                            </svg><span className="card__time">X hours</span>
                        </div>
                    </div> */}
                    <div className="card__img"
                        style={{
                            cursor: 'pointer',
                            backgroundImage: `url("${props.courseData?.image}")`
                        }}
                    ></div>
                    ...
                    <div className="card__info">
                        <span className="card__category"> {'Level: ' + props.courseData?.level}</span>
                        <h3 className="card__title">{props.courseData?.name}</h3>
                        <span className="card__by">
                            {'Instructor: ' + props.courseData?.firstName + ' ' + props.courseData?.lastName}
                        </span>
                    </div>
                </article>
            </section>
